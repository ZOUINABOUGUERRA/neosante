      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            color:
                _getStatusColor(_dossierData!['status']).withValues(alpha: 0.1),
            child: Row(
              children: [
                Icon(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  _buildInfoRow(
                      'Date naissance',
                      data['birthDateTime'] != null
                          ? DateFormat('dd/MM/yyyy HH:mm', 'fr_FR').format(
                              (data['birthDateTime'] as Timestamp).toDate())
                          : 'N/A'),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  _buildInfoRow(
                      'Mode d\'accouchement', data['deliveryMethod'] ?? 'N/A'),
          ...
          Card(
            child: Padding(
              ...
              child: Column(
                children: [
                  _buildInfoRow(
                      'Poids de naissance', '${data['birthWeight'] ?? '?'} g'),
                  _buildInfoRow(
          ...
          Card(
            child: Padding(
              ...
              child: Column(
                children: [
                  _buildInfoRow(
                      'APGAR 1 minute', '${data['apgar1'] ?? '?'}/10'),
                  _buildInfoRow(
                      'APGAR 5 minutes', '${data['apgar5'] ?? '?'}/10'),
                ],
              ),
            ),
          ),
  ...
  Widget _buildCareTab() {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          _buildSectionHeader(
              '🔧 Gestes systématiques', Icons.cleaning_services),
          Card(
            child: Padding(
              padding: const EdgeInsets.all(16),
              child: Column(
                children: [
                  ...
                  _buildInfoRow(
                      'Mise sous chaleur', data['miseSousChaleur'] ?? 'N/A'),
                ],
              ),
            ),
          ),
  ...
  Widget _buildSurveillanceTab() {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        final temps =
            documents.where((d) => d['type'] == 'temperature').toList();
                      ...
                      if (glucose.isNotEmpty)
                        _buildInfoRow(
                          ...
                          subtitle: glucose.first['recordedAt'] != null
                              ? DateFormat('dd/MM/yyyy HH:mm', 'fr_FR').format(
                                  (glucose.first['recordedAt'] as Timestamp)
                                      .toDate())
                              : null,
                        ),
                      if (temps.isNotEmpty)
                        _buildInfoRow(
                          ...
                          subtitle: temps.first['recordedAt'] != null
                              ? DateFormat('dd/MM/yyyy HH:mm', 'fr_FR').format(
                                  (temps.first['recordedAt'] as Timestamp)
                                      .toDate())
                              : null,
                        ),
                          ...
                          children: meds
                              .map((med) => ListTile(
                                    ...
                                    trailing: Chip(
                                      ...
                                      // ✅ Correction: withOpacity → withOpacity
                                      backgroundColor: med['isAdministered'] ==
                                              true
