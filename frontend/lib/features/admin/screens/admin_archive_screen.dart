...
class _AdminArchiveScreenState extends ConsumerState<AdminArchiveScreen> {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      IconButton(
                        icon: const Icon(Icons.restore, color: AppColors.stableGreen),
                        onPressed: () => _restoreArchive(archives[index].id),
                      ),
                      IconButton(
                        icon: const Icon(Icons.delete, color: AppColors.emergencyRed),
  ...
  Future<void> _restoreArchive(String id) async {
    ...
    context.showSuccessSnackBar('Dossier restauré');
  }
